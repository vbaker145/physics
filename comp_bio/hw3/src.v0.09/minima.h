...
class minima
{
  ...
  public:
	...
	void steepest_descents_arbitrary_step_one_particle(int particle, double step_size, double crit, forces &physics, ensemble& sys);
	// 	FOR ALL PARTICLES
	void steepest_descents_arbitrary_step(double step_size, double crit, forces &physics, ensemble& sys);
};
